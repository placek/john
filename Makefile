...
SOURCES = tools/egzegeza_jana_build.py data/schema.sql \
          ...
          data/swiatlosc.json data/abraham.json data/niewidomy.json data/pasterz.json data/poswiecenie.json data/lazarz.json data/kajfasz.json data/namaszczenie.json
